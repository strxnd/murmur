...
4. Build an LLM prompt from mode instructions, examples, vocabulary, transcript, and context.
5. If AI processing fails, fall back to the transcript.
6. Paste or leave output on the clipboard.
7. Store history.
