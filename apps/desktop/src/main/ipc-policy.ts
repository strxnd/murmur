...
export const ipcChannelsByRole = {
  main: [
    "app:get-state",
...
const channelsByRole: Record<RendererRole, ReadonlySet<string>> = {
  main: new Set(ipcChannelsByRole.main),
  pill: new Set(ipcChannelsByRole.pill),
  "mode-selector": new Set(ipcChannelsByRole["mode-selector"])
};
